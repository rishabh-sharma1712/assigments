...
var outsideClick = function (e) {
    ...
    if (!container.is(e.target) && container.has(e.target).length === 0 && container.is(':visible')) {
       ...
       window.document.unbind("click", outsideClick);
    }
 };

 var crossStringClick = function (elem) {
    var target = elem;
    var parentWithActiveClass = target.closest(document.getElementsByClassName('active'));
...
(function () {
 ...
 (function () {
    ...
    $(".custmonDropDwon").click(function (e) {
       if ((this.e.target).hasClass("crossString") || (this.e.target).hasClass("bowiro")) {
          return false;
       }
       ...
       if ((this.e.target).hasClass("language") || (this.e.target).parent().hasClass("language")) {
          languageFunc();
       ...
       if ((this.e.target).hasClass("searchCoinDrp")) {
          document.getElementById('tokensearch1').focus();
       }
 
       if (this.next(document.getElementsByClassName("customDrp")).length) {
        this.next(document.getElementsByClassName("customDrp")).classList.add("active");
       } else {
        this.children(document.getElementsByClassName("customDrp")).classList.add("active");
       }
 
       e.stopPropagation();
       window.document.bind("click", outsideClick);
    });
    ...
    (document.getElementsByClassName("basic_banner_read_btn")).addEventListener('click', function () {
    ...
    // filterToggelBtn
    document.getElementsByClassName("filterToggelBtn").addEventListener('click', function () {
        document.getElementsByClassName("filterToggel").slideToggle("active");
     })
 
    // ==  .hideCustomDrp == //
    document.getElementsByClassName("hideCustomDrp").addEventListener('click', function () {
    ...
    document.getElementsByClassName("closeIcon").addEventListener('click', function () {
        ...
        if (!document.querySelector(".headerMain").hasClass("active")) {
           document.body.style.overflow = 'auto';
        }
     })
    ...
    document.getElementsByClassName("mainTable").addEventListener("scroll", function (e) {
       let isScroll = e.currentTarget.scrollLeft;
       if (isScroll) {
        document.getElementsByClassName("ListingTable").th.nth-child(3).classList.add("before");
        document.getElementsByClassName("ListingTable").td.nth-child(3).classList.add("before");
       } else {
        document.getElementsByClassName("ListingTable").th.nth-child(3).classList.remove("before");
        document.getElementsByClassName("ListingTable").td.nth-child(3).classList.remove("before");
       }
    });
    
 
    // ==  responsiveTable currenciesTable == //
    let currTable = document.getElementsByClassName('currenciesTable')
    let exchgTable = document.getElementsByClassName('exchangeTable')

    currTable.addEventListener('scroll', function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
            document.getElementsByClassName("ListingTable").th.nth-child(2).classList.add("before");
            document.getElementsByClassName("ListingTable").td.nth-child(2).classList.add("before");
        } else {
            document.getElementsByClassName("ListingTable").th.nth-child(2).classList.remove("before");
            document.getElementsByClassName("ListingTable").td.nth-child(2).classList.remove("before");
        }
     })

     exchgTable.addEventListener('scroll', function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
            document.getElementsByClassName("ListingTable").th.nth-child(2).classList.add("before");
            document.getElementsByClassName("ListingTable").td.nth-child(2).classList.add("before");
    ...
    // .historical-data
    document.getElementsByClassName("historical-data").addEventListener("scroll", function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
         document.getElementsByClassName("ListingTable").th.nth-child(1).classList.add("before");
         document.getElementsByClassName("ListingTable").td.nth-child(1).classList.add("before");
        } else {
         document.getElementsByClassName("ListingTable").th.nth-child(1).classList.remove("before");
         document.getElementsByClassName("ListingTable").td.nth-child(1).classList.remove("before");
        }
     });
 
    // .financialTable
    document.getElementsByClassName("financialTable").addEventListener("scroll", function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
         document.getElementsByClassName("ListingTable").th.nth-child(1).classList.add("before");
         document.getElementsByClassName("ListingTable").td.nth-child(1).classList.add("before");
    ...
    let mobHeader = document.getElementsByClassName("header-for-mobile")
    let srchPopup = document.getElementsByClassName("searchPopup")

    mobHeader.addEventListener('click', function () {
        document.body.style.overflow = 'hidden'
        document.getElementsByClassName("searchDiv-for-mb").classList.add("active");
    })

    srchPopup.addEventListener('click', function () {
        document.body.style.overflow = 'hidden'
        document.getElementsByClassName("searchDiv-for-mb").classList.add("active");
    })
    ...
    $(function () {
        window.addEventListener('scroll', function () {
         ...
         document.getElementsByClassName("gototopIconDiv").addEventListener('click', function () {
            $("html, body").animate({
               scrollTop: "0",
            },
               500
    ...
    document.getElementsByClassName("popupRemover").addEventListener('click', function () {
 ...
 $(".faqAcc .flexAccHead").click(function () {
    let AccHeadObj = $(this);
    AccHeadObj.parent().siblings().children().classList.remove('active');
    AccHeadObj.parents(".faqAcc li").find(".faqDesc").classList.add("active", 2000);
 });
 // == === == faq scripts == == == //
 ...
 function toggleCurrencyMoreData(elem) {
    ...
    let currDetail = document.getElementsByClassName('currencyDetail')
    let bottList = document.getElementsByClassName('bottomListing')
 
    if (currentstate == alternate) {

        currDetail.style.display = "none"
        bottList.style.display = "none"
        
       elem.innerHTML = toggleCurrencyMoreDataState;
    } else {
        currDetail.style.display = "block"
